...
public class StatusCodes {
	...
	public static final String REGUPDATESUCCESS="Registration updated successfull";
	public static final String REGUPDATEERROR = "Getting Error While updating User";
